...
def get_model(point_cloud, is_training, num_class, bn_decay=None):
    ...
    net_ins_cache = tf_util.conv1d(net_ins, 5, 1, padding='VALID', bn=True, is_training=is_training, scope='ins_cache',  bn_decay=bn_decay)

    k = 30
    adj_matrix = tf_util.pairwise_distance_l1(net_ins_cache)
